...
urlpatterns = [
    ...
    path('subtopicos/<topico_id>/', views.sub_topicos,
         name='sub_topicos_tarefas'),
    ...
    path('new_sub_topico/<topico_id>', views.new_sub_topicos,
         name='novo_sub_topico'),
    path('edit_sub_topico/<sub_topico_id>', views.edit_sub_topico,
         name='editar_sub_topico'),
]
